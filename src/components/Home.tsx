                                                ...
                                                <div className="nk-ecwg nk-ecwg8 h-100">
                                                    <div className="card-inner">
                                                        ...
                                                        <ul className="nk-ecwg8-legends">
                                                            <li>
                                                                <div className="title">
                                                                    <span className="dot dot-lg sq" data-bg="#6576ff"></span>
                                                                    <span>Total Order</span>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div className="title">
                                                                    <span className="dot dot-lg sq" data-bg="#eb6459"></span>
                                                                    <span>Cancelled Order</span>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                        <div className="nk-ecwg8-ck">
                                                            <canvas className="ecommerce-line-chart-s4" id="salesStatistics"></canvas>
                                                        </div>

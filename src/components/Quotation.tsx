...
const Quotation = (props: MyComponentProps) => {
            ...
            .then(
                (response) => {
                    ...
                    if (response.data.status === 1) {
                        console.log("cot", response.data.data.quotations
                        )

                        setquotationData(response.data.data.quotations)
                    }
                },
                (error) => {
                    setLoading(false);
            ...
            <div className="nk-content-body">
              <div className="nk-block-head nk-block-head-sm">
                <div className="nk-block-between">
                  <div className="nk-block-head-content">
                    <h3 className="nk-block-title page-title">Quotation Page</h3>
                  </div>
                  <div className="nk-block-head-content">
              ...
              <div className="nk-block">
                <div className="nk-tb-list is-separate is-medium mb-3">
                  ...
                  {
                                        quotationData && quotationData.length > 0 && quotationData.map((item: any, index: number) => (
                                            <div key={item._id} className="nk-tb-item">
                                                ...
                                                <div className="nk-tb-col tb-col-sm">
                                                    <span className="tb-sub">{item.coordinator.cellNumber}</span>
                                                </div>
                                                ...
                                                <div className="nk-tb-col tb-col-sm">
                                                    <span className="tb-sub">{item.distanceFromKelowna}</span>
                                                </div>
                                                <div className="nk-tb-col tb-col-sm">
                                                ...
                                                <div className="nk-tb-col tb-col-sm">
                                                    <span className="tb-sub">{item.special_requirements}</span>
                                                </div>
...
export default IsLoadingHOC(IsLoggedinHOC(Quotation));